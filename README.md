...
**Add the node** - To add a terrain node, in the "Add node" screen, search for "Node3D->TerraBrush" (![image](https://github.com/spimort/TerraBrush/blob/main/demo/addons/terrabrush/terrabrush_node.png?raw=true))
