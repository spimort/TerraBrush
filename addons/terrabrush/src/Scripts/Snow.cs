...
public partial class Snow : Node3D {
    ...
    [BindProperty] public SnowResource SnowDefinition { get;set; }
    ...
    public void UpdateSnow() {
        ...
        if (SnowDefinition.CustomShader == null) {
            _clipmap.Shader = new ShaderMaterial() {
                Shader = ResourceLoaderHelper.Load<Shader>("res://addons/terrabrush/Resources/Shaders/snow_clipmap_shader.gdshader")
            };
        } else {
