...
public partial class Foliage : Node3D {
    ...
    [BindProperty] public int FoliageIndex { get;set; }
        ...
        if (Definition.Strategy == FoliageStrategy.MultiMesh)  {
            ...
            if (Definition.CustomShader == null) {
                shaderMaterial = new ShaderMaterial() {
                    Shader = ResourceLoaderHelper.Load<Shader>("res://addons/terrabrush/Resources/Shaders/foliage_multimesh_shader.gdshader")
                };
            } else {
    ...
    private async void UpdateFoliage() {
        ...
        if (Definition.Strategy == FoliageStrategy.MultiMesh) {
            ...
            _multiMeshInstance3D.Multimesh = new MultiMesh() {
                ...
                Buffer = new PackedFloat32Array([..Enumerable.Range(0, numberOfPoints).Select(_ => {
                    return new float[] {
                        1f, 0f, 0f, 0f,
                        0f, 1f, 0f, 0f,
                        0f, 0f, 1f, 0f
