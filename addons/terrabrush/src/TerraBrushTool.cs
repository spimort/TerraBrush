...
public partial class TerraBrushTool : Node3D {
    ...
    public virtual GodotArray<FoliageResource> Foliages { get; set; }
    public virtual GodotArray<ObjectResource> Objects { get; set; }
    public virtual WaterResource WaterDefinition { get; set; }
    public virtual SnowResource SnowDefinition { get; set; }
    public virtual GodotArray<MetaInfoLayer> MetaInfoLayers { get; set; }
