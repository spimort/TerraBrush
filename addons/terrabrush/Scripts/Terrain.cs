...
public partial class Terrain : Node3D {
	...
	[Export] public AudioCollectionsResource AudioCollection { get; set; }
	[Export] public int AudioTextureDetail { get; set; } = 1;
	[Export] public bool AudioUseAntiTile { get; set; } = true;
	[Export] public bool AudioNearestTextureFilter { get; set; } = false;
	[Export] public float AudioHeightBlendFactor { get; set; } = 10f;
	[Export] public AlphaChannelUsage AudioAlbedoAlphaChannelUsage { get; set; } = AlphaChannelUsage.None;
	[Export] public AlphaChannelUsage AudioNormalAlphaChannelUsage { get; set; } = AlphaChannelUsage.None;
	[Export] public bool AudioUseSharpTransitions { get; set; } = false;
